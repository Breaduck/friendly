          ...
          >
            ...
            <div className="relative bg-gray-900 aspect-video flex items-center justify-center">
              ...
              <div className="relative z-10 flex flex-col items-center gap-5 px-6 text-center">
                <div className="w-20 h-20 rounded-full bg-red-600 group-hover:bg-red-500 flex items-center justify-center transition-colors shadow-lg">
                  <svg width="30" height="30" viewBox="0 0 24 24" fill="white">
                    <path d="M8 5v14l11-7z"/>
                  </svg>
                </div>
                <div>
                  <p className="text-white text-base font-semibold mb-1.5">정다운교회 유튜브 채널</p>
                  <p className="text-white/60 text-sm">@JungDownChurch_AnYang</p>
                </div>
              </div>
            </div>

            {/* 채널 정보 */}
            <div className="bg-cream px-7 py-6 flex items-center gap-4">
              ...
              <div className="min-w-0 flex-1">
                <p className="font-semibold text-ink text-base">정다운교회 — 안양</p>
                <p className="text-muted text-sm mt-1">매주 주일 예배 실황 · 담임목사 말씀</p>
              </div>
              <div className="flex-shrink-0">
                <span className="text-sm font-medium text-red-600 bg-red-50 px-4 py-1.5 rounded-full whitespace-nowrap">
                  구독하기
                </span>
              </div>
            </div>
