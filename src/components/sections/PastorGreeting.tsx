    ...
    <Section id={NAV.pastor} aria-labelledby="pastor-heading">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
        ...
        <AnimatedSection className="lg:sticky lg:top-24">
          <div className="relative aspect-[3/4] max-w-sm mx-auto lg:mx-0 rounded-2xl overflow-hidden bg-cream shadow-md">
            <Image
              ...
              unoptimized
            />
            <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-accent-deep/80 p-8">
              <p className="text-white font-bold text-xl">
                {pastorInfo.name} {pastorInfo.title}
              </p>
              <p className="text-white/70 text-sm">정다운교회</p>
            </div>
          </div>
        </AnimatedSection>
        ...
        <div className="space-y-14">
          <AnimatedSection>
            ...
            <h2
              id="pastor-heading"
              className="text-4xl md:text-5xl font-bold text-ink tracking-[-0.025em] mb-10"
            >
              {pastorInfo.name} 목사님의
              <br />
              인사말
            </h2>
            <div className="space-y-5 text-charcoal leading-[2] text-[1.0625rem]">
          ...
          <AnimatedSection delay={0.15}>
            <h3 className="text-2xl font-bold text-ink mb-7">목회 철학</h3>
            <div className="space-y-4">
              {pastorInfo.philosophies.map((p, i) => (
                <div
                  key={i}
                  className="bg-cream rounded-2xl p-10 shadow-sm hover:shadow-md transition-shadow"
                >
